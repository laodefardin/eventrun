        ...
        <ul class="navbar-nav navbar-align">
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                    data-bs-toggle="dropdown">
                    <img src="https://appstack.bootlab.io/img/avatars/avatar.jpg"
                        class="img-fluid rounded-circle me-1 mt-n2 mb-n2" alt="Chris Wood" width="40"
                        height="40" /> <span>Chris Wood</span>
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="/proseslogoutadmin">Sign out</a>
                </div>
            </li>
        </ul>
    </div>
